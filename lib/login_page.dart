...
import 'package:quick_start/register_page.dart'; // Import your home screen
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              ...
              Center(
                child: const Text('Stay on top of your tasks with our Quick Task App',
                    style: TextStyle(fontSize: 12, color: Color.fromARGB(255, 119, 145, 165))),
              ),
              SizedBox(
                height: 26,
              ),
